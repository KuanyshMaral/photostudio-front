const API_ROOT = (import.meta.env.VITE_API_URL || 'http://89.35.125.136:8090').replace(/\/$/, '');
const API_BASE = API_ROOT.endsWith('/api/v1') ? `${API_ROOT}/admin` : `${API_ROOT}/api/v1/admin`;
